...
<head>
    ...
    <title>Departamento Infantil - IBSM Matamoros</title>
...
<body class="bg-gray-50 text-gray-800 font-sans antialiased">
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 bg-gray-50 p-8 rounded-2xl flex flex-col md:flex-row items-center gap-8">
                ...
                <div class="md:w-1/2">
                    <img src="<?=BASE_URL ?>assets/img/clases-2.jpg" class="rounded-xl shadow-lg">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-pink-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row-reverse items-center gap-12">
            <div class="md:w-1/2">
                <img src="<?=BASE_URL ?>assets/img/cuna.jpeg" class="w-96 h-60 rounded-xl shadow-2xl rotate-2 hover:rotate-0 transition duration-500 object-cover">
            </div>
            <div class="md:w-1/2">
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <img src="<?=BASE_URL ?>assets/img/serp.jpg" class="rounded-lg shadow hover:scale-105 transition duration-300">
                <img src="<?=BASE_URL ?>assets/img/ebdv-mc.jpg" class="rounded-lg shadow hover:scale-105 transition duration-300">
                <img src="<?=BASE_URL ?>assets/img/ninos-2.jpg" class="rounded-lg shadow hover:scale-105 transition duration-300">
                <img src="<?=BASE_URL ?>assets/img/dia-nino.jpg" class="rounded-lg shadow hover:scale-105 transition duration-300">
            </div>
        </div>
    </section>
