...
<head>
    ...
    <title>Jóvenes - IBSM Matamoros</title>
        ...
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <div class="grid md:grid-cols-3 gap-6 text-brand-dark">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <h4 class="font-bold text-lg">Sientete en casa</h4>
                    <p class="text-sm">Queremos que te sientas cómodo y bienvenido.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <img src="<?=BASE_URL ?>assets/img/jovenes-4.jpg" class="rounded-lg shadow hover:scale-105 transition duration-300">
                <img src="<?=BASE_URL ?>assets/img/jovenes-5.jpg" class="rounded-lg w-80 shadow hover:scale-105 transition duration-300">
                <img src="<?=BASE_URL ?>assets/img/jovenes-3.jpg" class="rounded-lg shadow hover:scale-105 transition duration-300">
                <img src="<?=BASE_URL ?>assets/img/jovenes-2.jpg" class="rounded-lg shadow hover:scale-105 object-fit transition duration-300">
            </div>
        </div>
    </section>
