    ...
    <nav class="bg-brand-white shadow-md fixed w-full z-50 transition-all duration-300" id="navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="creencias.php" class="text-brand-dark font-bold transition">¿Qué Creemos?</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-gray-100 shadow-xl">
            <div class="px-4 pt-2 pb-6 space-y-1">
                ...
                <a href="creencias.php" class="block px-3 py-2 text-base font-medium text-brand-dark bg-brand-light rounded-md">Doctrina & Salvación</a>
